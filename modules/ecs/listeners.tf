...
resource "aws_lb_listener_rule" "service_https_host_rule" {
  for_each = var.create_alb && var.create_https_listener && var.acm_certificate_arn != "" ? local.services_with_host_headers : {}
...
resource "aws_lb_listener_rule" "service_https_path_rule" {
  for_each = var.create_alb && var.create_https_listener && var.acm_certificate_arn != "" ? local.services_with_path_patterns : {}
