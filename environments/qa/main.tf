...
# ECS Cluster Module - Only with voice-agent
module "ecs" {
  source = "../../modules/ecs"
  ...
  # Pass only the voice-agent service configuration
...
# # Global Accelerator Module - COMMENTED OUT
...
# # Cloudflare Module - COMMENTED OUT
# module "cloudflare" {
...
# # Security Group Rule to allow ECS access to Redis - COMMENTED OUT
