...
locals {
  ...
  mongodb_connection_string = module.mongodb.connection_string # "mongodb+srv://doadmin:2wP6eJ810Sa573WI@db-mongodb-nyc3-50305-ea8e643e.mongo.ondigitalocean.com/ten_xr_agents_qa?tls=true&authSource=admin&replicaSet=db-mongodb-nyc3-50305"
