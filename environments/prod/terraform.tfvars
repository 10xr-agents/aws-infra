...
services = [
  ...
  {
    name              = "cnvrs-ui"
    ecr_repo          = "761018882607.dkr.ecr.us-east-1.amazonaws.com/10xr/converse-ui:production-latest"
    cpu               = 1024
    memory            = 2048
    desired_count     = 2
    instance_type     = "medium"
    port              = 3000
    health_check_path = "/api/server/health"
    environment_variables = {
      "ENV"                    = "production"
      "ECS_ENVIRONMENT"        = "production"
      "SPRING_PROFILES_ACTIVE" = "production"
...
mongodb_cluster_id         = "67b85aadcd20730f1e9652d2"
mongodb_standard_srv       = "mongodb+srv://ten-xr-storage-prod.3njzs.mongodb.net"
mongodb_cluster_name       = "ten-xr-storage-prod"
